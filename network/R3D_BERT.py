    ...
    def __init__(self, in_channels, out_channels, kernel_size, downsample=False):
        ...
        if self.downsample:
            ...
            self.downsampleconv = SpatioTemporalConv(
                in_channels, out_channels, 1, stride=(1, 2, 2)
            )
...
class R3DNet_BERT(nn.Module):
    ...
    def __init__(self, in_channels,
                       ...
                       dropout_rate=0.8,
                       block_type=SpatioTemporalResBlock):
        super(R3DNet_BERT, self).__init__()
        ...
        self.avgpool = nn.AvgPool3d((1, 4, 4), stride=1) # Out of of 5 conv layer is (7, 7)


        # first conv, with stride 1x2x2 and kernel size 3x7x7
        self.conv1 = SpatioTemporalConv(
            in_channels, 64, [3, 7, 7], stride=[1, 2, 2], padding=[1, 3, 3]
        )
...
class R3D_BERTClassifier(nn.Module):
