...
def train_model(
    ...
    train_dataloader = DataLoader(
        VideoDataset(dataset=dataset, split="train", clip_len=16),
        batch_size=20,
        shuffle=True,
        num_workers=4,
    )
    val_dataloader = DataLoader(
        VideoDataset(dataset=dataset, split="val", clip_len=16),
        batch_size=20,
        num_workers=4,
    )
    test_dataloader = DataLoader(
        VideoDataset(dataset=dataset, split="test", clip_len=16),
        batch_size=20,
        num_workers=4,
    )
